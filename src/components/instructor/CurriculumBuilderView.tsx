...
export default function CurriculumBuilderView({ onSaveCurriculum, availableLessons = [], classes = [], curriculums = [] }: any) {
    ...
    const handleImportJSON = () => {
        try {
            ...
            setSelectedClassId(''); // Unhook from any existing class if they import fresh JSON
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 bg-white dark:bg-slate-900 p-4 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <div className="flex items-center gap-3">
                            ...
                            {/* 🔥 THE EDIT SELECTOR (Always Visible on Desktop) */}
                            <select 
                ...
                <div className="flex items-center gap-3 w-full md:w-auto">
                    ...
                    <button 
                        ...
                        className="px-4 py-2 bg-slate-900 dark:bg-slate-800 text-white font-black text-[10px] uppercase tracking-widest rounded-xl hover:bg-slate-800 dark:hover:bg-slate-700 transition-colors flex items-center justify-center gap-2 shrink-0"
                    >
                        <Code size={14} /> Import
                    </button>
