...
export default function GradebookMatrix({ classData, lessons, activityLogs }: any) {
    ...
    return (
        <div className="flex flex-col h-full bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-100 font-sans overflow-hidden rounded-[2rem] border border-slate-200 dark:border-slate-800 shadow-sm">
            <header className="p-6 md:p-8 border-b border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 backdrop-blur-xl shrink-0">
                <div className="flex flex-col xl:flex-row justify-between items-start xl:items-end gap-6">
                    <div>
                        <h1 className="text-2xl md:text-3xl font-black uppercase tracking-tight flex items-center gap-3">
                            <BookOpen className="text-indigo-500" /> Gradebook Matrix
                        </h1>
                        <p className="text-slate-500 dark:text-slate-400 text-xs font-bold uppercase tracking-[0.2em] mt-1">Class Performance Overview</p>
                    </div>

                    <div className="flex flex-wrap gap-4 items-center bg-white dark:bg-slate-950 p-3 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
                        <Settings2 size={18} className="text-slate-400 mx-2 shrink-0" />
                        {categories.map((cat: any) => (
                            <div key={cat.id} className="flex items-center gap-2 pr-4 border-r last:border-0 border-slate-100 dark:border-slate-800">
                                ...
                                <div className="relative flex items-center">
                                    <input 
                                        ...
                                        className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg pl-3 pr-6 py-1.5 w-16 font-bold text-sm focus:border-indigo-500 outline-none text-slate-700 dark:text-slate-200 transition-all text-center"
                                    />
                    ...
                    <div className="flex gap-3 w-full xl:w-auto">
                        <button className="p-3 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 rounded-xl transition-all shadow-sm active:scale-95 shrink-0">
                            <Download size={20} />
                        </button>
                        <div className="relative flex-1 xl:flex-none">
                            ...
                            <input 
                                ...
                                className="bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl pl-11 pr-4 py-3 w-full xl:w-64 font-bold focus:w-full xl:focus:w-80 transition-all outline-none text-slate-700 dark:text-white shadow-inner text-sm"
                            />
                        </div>
                    </div>
                </div>
